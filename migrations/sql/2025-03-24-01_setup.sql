...
CREATE TABLE IF NOT EXISTS `card_iterations` (
    ...
    `enflowable` BOOL NOT NULL,
    `speed_modifier` VARCHAR(4) NOT NULL,
    `zone_modifier` VARCHAR(6) NOT NULL,
    `starting_life` INT UNSIGNED NOT NULL,
    `burden` INT UNSIGNED NOT NULL,
    `card_type` VARCHAR(8) NOT NULL,
    `rules_text` TEXT NOT NULL,
    `attack` INT SIGNED NOT NULL,
    `defense` INT SIGNED NOT NULL,
